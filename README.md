...
## Instructions:
__ONLY THE FIRST TIME EVER YOU RUN THE PROGRAM: run the program (FtE.exe) as administrator (it is just for configuration, you have to this only once and the FIRST time you start the program) without any P7M file inside (it would just delete them)__
